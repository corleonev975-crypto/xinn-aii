document.addEventListener("DOMContentLoaded", () => {
  ...
  const sendBtn = $("sendBtn"), input = $("messageInput"), chatArea = $("chatArea"), welcome = $("welcome");
  const menuBtn = $("menuBtn"), closeSidebarBtn = $("closeSidebarBtn"), sidebar = $("sidebar"), overlay = $("overlay");
  const moreBtn = $("moreBtn"), moreMenu = $("moreMenu"), plusBtn = $("plusBtn"), plusMenu = $("plusMenu");
  const clearChatBtn = $("clearChatBtn"), newChatBtn = $("newChatBtn"), exportChatBtn = $("exportChatBtn"), themeBtn = $("themeBtn"), aboutBtn = $("aboutBtn");
  const historyList = $("historyList");
  const photoInput = $("photoInput"), cameraInput = $("cameraInput"), fileInput = $("fileInput");
  ...
  moreBtn.onclick=e=>{e.stopPropagation();moreMenu.classList.toggle("active");plusMenu.classList.remove("active")};
  plusBtn.onclick=e=>{e.stopPropagation();plusMenu.classList.toggle("active");moreMenu.classList.remove("active")};
  ...
  exportChatBtn.onclick=()=>{
    ...
    a.href=url; a.download="xinn-ai-chat.json"; a.click();
